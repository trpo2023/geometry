...
CFLAGS_TEST = -I src -MMD -I thirdparty
...
$(TEST_PATH): $(TEST_OBJ_PATH)/main.o $(TEST_OBJ_PATH)/parser_test.o $(LIB_OBJECTS)
	$(CC) $(CFLAGS) $(CFLAGS_TEST) -o $@ $^ -lm
	
$(OBJ)/$(TEST_DIR)/%.o: $(TEST_DIR)/main.c $(TEST_DIR)/parser_test.c $(LIB_OBJECTS)
