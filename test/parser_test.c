...
CTEST(check_syntax_extra_character,test3) 
{
    ...
    ASSERT_TRUE(check_syntax_extra_character(test_check_syntax_extra_character_1,24));
    ASSERT_TRUE(check_syntax_extra_character(test_check_syntax_extra_character_2,24));
    ASSERT_FALSE(check_syntax_extra_character(test_check_syntax_extra_character_3,26));
}
...
CTEST(reading_elements,test5)
{
    ...
    test_reading_elements_1 = reading_elements(test_reading_elements_1,str,1,8);
    test_reading_elements_2 = reading_elements(test_reading_elements_2,str,1,12);
    test_reading_elements_3 = reading_elements(test_reading_elements_3,str,2,19);
